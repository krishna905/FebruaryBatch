...
public class HeapSortAscending {
    ...
    public static void main(String[] args) {
        HeapSortAscending heapSortAscending = new HeapSortAscending(15);
        int requiredSize = 9;
        int range = 50;
        ...
        for(int i = 0; i < requiredSize; i++) {
            ...
            heapSortAscending.insert(randomNumber);
        }

        heapSortAscending.printHeap();

        System.out.println("Sorted: ");
        int initialSize = heapSortAscending.size;
        for(int i = 0; i < initialSize; i++) {
            int rootElement = heapSortAscending.extractFirstElement();
